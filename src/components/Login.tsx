      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 dark:from-indigo-500 dark:via-purple-500 dark:to-pink-500 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-white p-12">
          ...
          <p className="text-xl text-center text-white/90 max-w-md">
            Your trusted platform for secure authentication and seamless ticket
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
            ...
            <div className="text-xs text-blue-700 dark:text-blue-300 space-y-1">
              <p>
                <strong>Admin:</strong> admin@nexttrack.com / password123
              </p>
              <p>
                <strong>Support:</strong> support@nexttrack.com / password123
              </p>
              <p>
                <strong>User:</strong> user@nexttrack.com / password123
              </p>
              <p>
                <strong>Reggie:</strong> reggie@medishure.com / MountE2025!
              </p>
            </div>
