...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-6 w-full max-w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 w-full overflow-hidden">
        {metrics.map((metric, index) => (
          <div key={index} className="card p-4 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer overflow-hidden">
    ...
    stroke: {
                        curve: 'smooth',
      width: 3,
                        colors: [metric.color === 'bg-green-500' ? '#10B981' : 
                                metric.color === 'bg-orange-500' ? '#F97316' : 
                                metric.color === 'bg-purple-500' ? '#8B5CF6' : 
                                metric.color === 'bg-red-500' ? '#EF4444' : '#3B82F6']
    },
    fill: {
      type: 'gradient',
      gradient: {
        ...
        colorStops: [
          {
            offset: 0,
                              color: metric.color === 'bg-green-500' ? '#10B981' : 
                                     metric.color === 'bg-orange-500' ? '#F97316' : 
                                     metric.color === 'bg-purple-500' ? '#8B5CF6' : 
                                     metric.color === 'bg-red-500' ? '#EF4444' : '#3B82F6',
                              opacity: 0.7
        ...
        <div className="lg:col-span-2 card p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl border border-blue-200 dark:border-blue-700">
                ...
                <h4 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Today's Tickets</h4>
              ...
              <div className="text-center p-4 bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-xl border border-green-200 dark:border-green-700">
                ...
                <h4 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">This Week's Tickets</h4>
                <p className="text-2xl font-bold text-green-600 dark:text-green-400">312</p>
                <div className="flex items-center justify-center mt-2">
                  <span className="text-xs text-green-600 dark:text-green-400 font-medium">+8.7%</span>
              ...
              <div className="text-center p-4 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-xl border border-purple-200 dark:border-purple-700">
                ...
                <h4 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">This Month's Tickets</h4>
            ...
            <div className="mt-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-sm font-bold text-gray-900 dark:text-white">87.3%</span>
              </div>
              <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                <div className="bg-gradient-to-r from-green-500 to-blue-500 h-2 rounded-full transition-all duration-500 ease-out" style={{ width: '87.3%' }}></div>
              </div>
          ...
          <div className="mt-6 p-4 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800/50 dark:to-gray-700/50 rounded-xl border border-gray-200 dark:border-gray-600">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-lg font-bold text-green-600 dark:text-green-400">1,089</p>
              ...
              <div className="text-center">
                ...
                <p className="text-lg font-bold text-purple-600 dark:text-purple-400">1,334</p>
                  ...
                  <tr className="hover:bg-gray-50 dark:hover:bg-dark-700 transition-colors">
                    <td className="py-3 px-2">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-gray-900 dark:text-white">Maria Johnson</p>
                          <p className="text-xs text-gray-500 dark:text-gray-400">maria.johnson@company.com</p>
                        </div>
                      </div>
                    </td>
                    <td className="py-3 px-2">
                  ...
                  <tr className="hover:bg-gray-50 dark:hover:bg-dark-700 transition-colors">
                    <td className="py-3 px-2">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-gray-900 dark:text-white">David Wilson</p>
                          <p className="text-xs text-gray-500 dark:text-gray-400">david.wilson@company.com</p>
                        </div>
                      </div>
                    </td>
                    <td className="py-3 px-2">
            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-500 to-blue-600 rounded-t-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-blue-100 text-sm">Online • Responds in 2 min</p>
                </div>
              </div>
                <button 
                    ...
                    <div className={`rounded-lg px-3 py-2 max-w-xs ${
                     ...
                     {message.sender === 'user' && (
                       <div className="w-8 h-8 bg-gray-300 dark:bg-gray-600 rounded-full flex items-center justify-center flex-shrink-0">
                         <span className="text-gray-600 dark:text-gray-300 text-sm font-semibold">M</span>
                       </div>
                     )}
                   </div>
                 ))
